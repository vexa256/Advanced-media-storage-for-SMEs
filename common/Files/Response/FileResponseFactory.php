...
use Common\Files\Providers\Backblaze\BackblazeAdapter;
...
class FileResponseFactory
{
    ...
    private function resolveResponseClass(FileEntry $entry, $disposition = 'inline')
    {
        ...
        if ($disposition === 'inline' && $this->shouldRedirectToRemoteUrl($entry)) {
    ...
    private function shouldRedirectToRemoteUrl(FileEntry $entry)
    {
        ...
        $remoteSupportsUrl = $adapter instanceof AwsS3Adapter || $adapter instanceof BackblazeAdapter;
