 ...
 * Generated for Laravel 7.18.0 on 2020-07-06 18:20:06.
 *
...
namespace Clockwork\Support\Laravel { 
    ...
    class Facade {
         ...
         * @static 
         */ 
        public static function addEmail($subject, $to, $from = null, $headers = [], $data = [])
        {
                        /** @var \Clockwork\Clockwork $instance */
                        return $instance->addEmail($subject, $to, $from, $headers, $data);
        }
         ...
         * @static 
         */ 
        public static function addView($name, $viewData = [], $data = [])
        {
                        /** @var \Clockwork\Clockwork $instance */
                        return $instance->addView($name, $viewData, $data);
        }
